<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatientInfo.aspx.cs" Inherits="HospitalProject.HospitalForm" %>
...
<body>
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
            <form id="form1" runat="server" style="background-color:brown;padding-top:0px" >
                <br />
                <h1 style="text-align:center;color:white" class="form-container">New Patient Registration </h1>
                <br />
                <div style="background-color:brown">
                <div style="padding-left:10px;padding-right:20px;padding-top:15px; background-color:white; margin-left: 414px; height: 683px; width: 648px; margin-right: 823px;">
