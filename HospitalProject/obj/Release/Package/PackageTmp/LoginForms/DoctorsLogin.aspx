<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoctorsLogin.aspx.cs" Inherits="HospitalProject.LoginForms.DoctorsLogin" %>
        ...
        <div>
            <asp:MultiView ID="MultiView1" runat="server">
                ...
                <asp:View ID="View2" runat="server">
                    ...
                    <div style="background-color: firebrick; height: 1080px">
